...
const DICT = {
  ...
  costBreakdownTitle: { en: "Where this cost comes from", ja: "費用の内訳" },
  costBreakdownIntro: {
    en: "The advertised rent is just the room. Effective monthly spreads the full 2-year cost below evenly across 24 months — that's the gap.",
    ja: "広告家賃は部屋代のみです。実質月額は以下の2年間の総費用を24ヶ月で均等に割った金額です。",
  },
  costFreqMonthly: { en: "monthly", ja: "毎月" },
  costFreqOneTime: { en: "one-time", ja: "一回のみ" },
  costFreqPerYear: { en: "per year", ja: "年1回" },
  costFreqRenewal: { en: "at each renewal", ja: "更新時" },
  costNotStatedTitle: { en: "Not stated by this listing", ja: "このリスティングに未記載" },
  costDisclaimer: {
    en: "Every amount above is only what this listing actually states — nothing is estimated. Fees below aren't included in the total, so the real cost could be higher.",
    ja: "上記の金額はすべてこのリスティングに実際に記載されているものです（推定なし）。以下の費用は合計に含まれていないため、実際の費用はさらに高くなる可能性があります。",
  },
